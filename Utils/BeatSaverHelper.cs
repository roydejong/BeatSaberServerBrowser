...
namespace ServerBrowser.Utils
{
    public static class BeatSaverHelper
    {
        ...
        public static async Task<byte[]> FetchCoverArtBytesForLevel(string levelId, CancellationToken token)
        {
            ...
            if (!String.IsNullOrEmpty(coverURL))
            {
                ...
                return await CoverArtGrabber.FetchCoverArtBytesForUrl("https://beatsaver.com" + coverURL, token);
            }
